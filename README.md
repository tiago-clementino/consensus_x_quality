...
Os dados foram utilizados originalmente por [Agrawal et al. 2015]. Por razões éticas, Agrawal et al filtraram todas as referências nominais aos autores de cada postagem, preservando assim seu anonimato. Em seguida, eles ponderaram manualmente as postagens dos estudantes por urgência ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/1_7.gif) - i.e., a faixa de números inteiros ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/geq_1.gif) e ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/leq_7.gif), onde 1 representa a menor urgência e 7, a maior; positividade ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/1_7.gif); e, confusão ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/1_7.gif). As postagens foram ainda classificadas como pergunta ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/_0_1_.gif) - não ou sim, respectivamente; resposta ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/_0_1_.gif); ou, opinião ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/_0_1_.gif). Deve-se notar que o campo "confusão" parece ter sido mensurado em escala invertida, medindo na verdade a "convicção" em cada postagem. 

Com os dados já tratados, classificamos manualmente cada postagem como sendo de autoria ou não de um instrutor ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/_0_1_.gif). Além disto, urgência, positividade e confusão (convicção) foram mapeados para a faixa de números decimais ![alt text](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/0_1.gif), afim de normalizar nossa análise.
...
Em sistemas de apoio ao consenso, sobretudo em ambientes online, opiniões e preferências tendem a apresentar incertezas e imprecisões que tem sido abordadas usando a Lógica Difusa [Herrera-Viedma et al. 2014,  Cabrerizo et al. 2015]. Porém, diferenciando-se de discussões convencionais, os fóruns online agregam incerteza até mesmo no processo de discussão. Sendo assim, no âmbito deste estudo, é necessário fazer adaptações nos modelos estado da arte de suporte ao consenso com incerteza [Pérez et al. 2018]. No cálculo de consenso que propomos, postagens de alunos e instrutores estão definidas em ![P={p^1,... ,p^m}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/p_1_m.gif), sendo *m* o total de postagens por discussão. Suas respectivas preferências são extraídas da proximidade textual entre cada postagem e comparações pareadas entre as opiniões disponíveis ![X={x^1,... ,x^n}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/x_1_n.gif), sendo *n* o total de opiniões por discussão. Por simplicidade, mas sem perda de generalidade, aqui assumem-se todos os pesos das postagens / opiniões de instrutores e alunos como iguais.

**Definição 2:** Tomando *X* como o conjunto de opiniões e *P* como o conjunto de postagens da discussão, a função ![\Delta^{-1}_{P,X}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta__1_PX.gif) é definida como uma função de similaridade dada entre uma postagem ![p\in P](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/p_e_P.gif) e uma opinião ![x\in X](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/x_e_X.gif), sendo ![\Delta^{-1}_{P,X}: P\times X\to [0,1]](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta_def.gif).

**Definição 3:** O conjunto de relações de preferência ![M=\{\mu^1,... ,\mu^u\}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/m_1_u.gif), sendo *u* o total de preferências me uma dada discussão, pertence ao conjunto das relações ![\Delta^{-1}_{P,X}\times \Delta^{-1}_{P,X}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta_por_delta.gif) e é definida por ![M: \Delta^{-1}_{P,X}\times \Delta^{-1}_{P,X}\to[0,1]](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta_por_delta_def.gif).

Assim, podemos entender ![\mu^p_{i,j}\in M](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/u_e_E.gif) como a relação de preferência/precedência extraída de *p* entre as opiniões ![x^i](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/x_i.gif) e ![x^j](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/x_j.gif), sendo ![\mu^p_{i,j}=\mu(\Delta^{-1}_{p,x^i},\Delta^{-1}_{p,x^j})(\forall p\in P,~\forall x\in X,~\forall i,j\in \{1,..., n\})](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/u_def.gif). Diante disto, para identificar o grau de consenso da discussão, devemos calcular quatro níveis de apoio - relação de preferência - entre o conjunto de postagens e o de opiniões disponíveis: 1) entre pares de opiniões; 2) entre opiniões e postagens; 3) entre postagens e opiniões; e, 4) geral [Pérez et al. 2018].

 - Nível 1: *Par de Alternativas -* Este nível consiste em gerar uma matriz de similaridade para cada par de postagens em relação a cada par de opiniões ![SP^{i,j}=(sp^{i,j}_{k,l}),\forall p^i,p^j\in P(i\neq j),\forall x^k,x^l\in X (k\neq l)](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/SP_def.gif), conforme a equação: 

![sp^{i,j}_{k,l}=1-{|\mu^{p^i}_{k,l}-\mu^{p^j}_{k,l}|}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/sp__def.gif)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(2)

 Forma-se, assim, uma matriz de quatro dimensões ![SP_{(m \times m)\times (n \times n)}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/SP_matrix.gif) comparando as preferências de todas as postagens duas a duas ![(m \times m)](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/m_x_m.gif) em função às preferências daquela postagem com relação à cada par de opiniões comparadas ![(n \times n)](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/n_x_n.gif). Em seguida, com base em uma função de agregação determinada ![\Phi](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/phi.gif), obtemos duas matrizes de preferência coletiva 1) comparando pares de opiniões agregando ![SP_{(m \times m)\times (n \times n)}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/SP_matrix.gif) por postagem
 
 ![sp_{k,l}=\Phi^i(\Phi^j(sp^{i,j}_{k,l})) \forall i,j\in \{1,...,m\}~|~i\neq j](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/spkl.gif)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(3)
 
 e 2) pares de postagens agregando ![SP_{(m \times m)\times (n \times n)}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/SP_matrix.gif) por opinião
 
 ![sp^{i,j}=\Phi_k(\Phi_l(sp^{i,j}_{k,l}) \forall k,l\in \{1,...,n\}~|~k\neq l](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/spij.gif)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(4)
 
 Aqui usaremos a média harmônica como ![\Phi](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/phi.gif); 

 - Nível 2: *Opiniões e Postagens -* Aqui é definido o nível de consenso para cada opinião ![cx_k,\forall k\in \{1,...,n\}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cx_def.gif), calculado em função de todas as postagens *P* (já agregadas no nível anterior): 
 
 ![cx_k=\frac{\sum^n_{l=1,l\neq k}(sp_{k,l} + sp_{l,k})}{2(n-1)}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cx.gif)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(5)
 
 - Nível 3: *Postagens e Opiniões -* Este nível de consenso é adotado apenas neste trabalho e cria uma matriz de similaridade de natureza oposta à do nível anterior. Aqui é definido a ordem de similaridade em função de todas as opiniões *X* (já agregadas no nível anterior) com relação à cada postagem ![cp_i,i\in\{1,...,m\}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cp_def.gif), conforme a equação:
 
 ![cp_i=\frac{\sum^m_{j=1,j\neq i}(sp_{i,j} + sp_{j,i})}{2(m-1)}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cp.gif)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(6)
 
 - Nível 4: *Geral -* O nível final de consenso *cg* é definido como
 
 ![cg=\frac{\sum^n_{k=1}cx_k}{n}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cg.gif)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(7)
...
Afim de concluir nossa análise, sempre que a maioria dos instrutores apoiar uma dada opinião, tomamos esta como a mais acertada. Sendo assim, tomamos *DP* como um vetor de duas dimensões onde na primeira estão as discussões e na segunda, as postagens correspondentes, e identificamos a postagem *p* da discussão *d* na posição *i* como ![p_{di}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/pdi.gif); e, *DA* como outro vetor também de duas dimensões correspondendo a discussões e opiniões dos instrutores, respectivamente. Seja agora, ![a_{di}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/adi.gif) a iézima postagem de um instrutor na discussão *d* e ![a_{di}(x)](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/adix.gif), uma função definida no conjunto ![\{0,1\}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/_0_1_.gif) que representa o apoio daquela postagem de instrutor à opinião ![x\in DX](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/x_e_DX.gif), onde *DX* é outro vetor com dois componentes onde o primeiro representa discussões e o segundo, postagens marcadas como sendo opiniões. Temos então, que a qualidade da opinião ![x_{di}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/xdi.gif) é definida por 

 ![q_{x_{di}}=\sum_{i=1}^{k}\frac{a_{di}(x_{di})}{k}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/qxdi.gif)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(8)
 
Na Equação 8, *k* é a quantidade total de opiniões de instrutores na discussão *d*. Assim, quanto mais apoio dos instrutores, maior a qualidade agregada àquela opinião. Deste modo, a qualidade de uma opinião é definida no domínio ![q\in 0,0;1,0](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/q_e_01010.gif). Além disto, o conceito de consenso utilizado para esta análise está definido no domínio ![0,0;1,0](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/01010.gif), porém acaba restrito ao domínio ![0,5;1,0](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/05010.gif), sendo ![c=0,5](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/c_05.gif) o grau de consenso puramente aleatório. Para enquadrar nossos resultados nos modelos estatísticos apresentados a seguir, normalizamos o consenso em ![0,0;1,0](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/01010.gif), tal qual a razão de qualidade *q*.
...
Nossa primeira análise visa perceber a influência do consenso na qualidade das postagens de modo mais gráfico. Para tanto, utilizamos uma estratégia envolvendo o intervalo de confiança IC da média de apoio dos instrutores à opinião de consenso, calculado utilizando amostragem por *bootstraping*. Aqui, a questão que queremos responder é: *Com 95% de confiança, o apoio dos instrutores à opinião consensual, definido conforme Equação 8, é significativo (![p<0,05](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/p_05.gif)) e relevante (![q_x\pm IC>0,5\mbox{~ou~}q_x\pm IC<0,5](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/q_0510.gif))?*. Isto significa que para nossa hipótese nula ser rejeitada, todo o intervalo de confiança deve estar abaixo ou acima da marca de 0.5 ou 50\% de apoio dos instrutores. Conforme é apresentado na Figura&nbsp;1, salvo uma única exceção para discussões de "baixa convicção" (e menos de seis postagens, conforme Figura&nbsp;1&nbsp;(C)&nbsp;), podemos afirmar com 95% de confiança, que os instrutores, em média, não apoiam a opinião de consenso na maioria dos casos analisados e no caso geral, rejeitando a hipótese nula para tais casos. Ainda com relação à Figura&nbsp;1: "Baixo Consenso" (![\mbox{consenso}\geq0,8](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/consenso_08.gif)), "Alto consenso" (![\mbox{consenso}\geq0,9](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/consenso_09.gif)), "Baixa convicção"(![\mbox{convicção média}<0,5](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/conv_med_05.gif)), "Alta convicção"(![\mbox{convicção média}\geq4.0](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/conv_med__05.gif)) e o caso "Geral" envolvendo todos os dados. Cada intervalo de confiança foi calculado com base em três métricas de distância, conforme legenda: DISCO, distância de edição e Wordnet.

![Imagem&nbsp;1](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/IC_2.png)
...
Com base nestes resultados preliminares, somos levados a crer que a relação entre consenso e qualidade é na verdade inversamente proporcional. Contudo, a média é uma grandeza muito sensível à influência de valores extremos. Assim, recorremos a um modelo de regressão logística [Gelman and Hill 2006] para investigar o relacionamento entre nível de consenso e apoio dos instrutores à opinião consensual. A partir daí, tomando o consenso como a variável a ser investigada, e para adequar nosso problema a tal modelo, a partir dos dois limiares de consenso já mencionados (![\delta_1=0,8](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta_08.gif) e ![\delta_2=0,9](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta_09.gif)), traduzimos o consenso em uma variável binária assumindo 0 quando ![cg<\delta](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cg_delta.gif) e 1 quando ![cg\geq\delta](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cg__delta.gif).

Em regressão logística, fatores com coeficientes positivos (![\beta](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/beta.gif)) estão positivamente correlacionados à variável sob investigação. Novamente, tomamos a taxa de apoio dos instrutores ao consenso como fator principal e a convicção como um fator que também poderia influenciar o consenso, nossa variável sob análise. Assim, um aumento na taxa de apoio dos instrutores à opinião majoritária, acompanhado do aumento na frequência com que se alcança o limiar ![\delta](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta.gif) de consenso, validará a afirmação que consenso e qualidade, medida em função do apoio dos instrutores, estão relacionados.

Além de efeitos fixos (fatores), devemos também levar em consideração os efeitos aleatórios já apresentados no modelo baseado em intervalos de confiança: a métrica de distância textual e o total de postagens por discussão. Isto porque devemos assimilar o fato de que a métrica de distância textual é automática e agrega certa imprecisão, além de que um grande volume de postagens leva à uma dispersão no foco de discussão que pode prejudicar o consenso. A partir da Tabela&nbsp;1, podemos ver que ambos os efeitos aleatórios exercem influência no *intercept* da função de regressão com variância ![s^2](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/s_2.gif) igual à 0,52 e 0,30 para ![cg_2](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cg2.gif); e ![s^2](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/s_2.gif) igual à 0,72 e 0,69 para ![cg_1](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cg1.gif). Assim os fatores: "Apoio dos instrutores" e "Convicção média" para ![cg_2](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cg2.gif) são menos susceptíveis a efeitos aleatórios.

![Tabela&nbsp;1](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/tabela1.png)

Ainda com base na Tabela&nbsp;1, em números absolutos, vemos que todos os coeficiente para ![cg_2](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cg2.gif) são bastante significativos, com ![p<0,001](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/p_0001.gif). Porém, para ![cg_1](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/cg1.gif), a convicção média parece ser um fator pouco significativo. A variância ![s^2](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/s_2.gif) para ambos os efeitos aleatórios (distância textual e quantidade de postagens) parece invalidar os resultados para um baixo limiar de consenso ![cg_1~|~\delta_1=0.8](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/c_delta_08.gif), uma vez que neste caso ![s^2_{cg_1}\in\{0,72,0,69\}\mbox{, e}~s^2_{cg_1}\approx|\beta|,\beta=-0,75](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/sci2.gif). Assim, podemos descartar o estudo para baixo consenso. Já em se tratando do alto limiar de consenso, ![\delta_2=0,9](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta_09.gif), a magnitude de ![\beta](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/beta.gif) parece sempre significativa com relação aos efeitos aleatórios ![s^2_cg_2\in\{0,52,0,30\}\mbox{, assim}~s^2_cg_2<|\beta|,\beta\in\{-1,88,-3,29\}](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/sc22.gif).

A partir destes resultados podemos concluir que o apoio dos instrutores, tomado como parâmetro de qualidade, está significativamente relacionado ao consenso (![p<0,001](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/p_0001.gif)) a um limiar ![\delta_2=0,9](https://github.com/tiago-clementino/consensus_x_quality/raw/master/images/delta_09.gif), exercendo um influência negativa da ordem de -0,032 para cada décimo de consenso, de acordo com a regra da divisão por quatro  [Gelman and Hill 2006].
