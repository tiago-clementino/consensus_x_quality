...
Para aprofundar o entendimento a respeito do modelo de consenso utilizado, tomaremos como exemplo um cenário simples com seis postagens e apenas duas opiniões. Sendo x^1 e x^2 as opiniões disponíveis e p^1,p^2,p^3,p^4,p^5 e p^6 as postagens, considere x^1 e x^2 como sendo as postagens ![0,0;1,0](https://drive.google.com/uc?export=view&id=1EtC4DX-ZD3iB4dWUj10wk2vKFDR8kzW9) e p^2 respectivamente.
