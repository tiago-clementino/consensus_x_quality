...
e a segunda matriz em função das postagens,
 ...
 ![\Phi_k(\Phi_l(sp^{i,j}_{k,l})))=\Phi_k\circ\Phi_l=\Phi_l\circ\Phi_k=\begin{bmatrix}- & 0,5 & 0,5 & 0,5 & 0,5 & 0,5 \\ 0,5 & - & 0,5 & 0,5 & 0,5 & 0,5 \\ 0,5 & 0,5 & - & 0,5 & 0,5 & 0,5 \\ 0,5 & 0,5 & 0,5 & - & 0,5 & 0,5\\0,5 & 0,5 & 0,5 & 0,5 & - & 0,5\\ 0,5 & 0,5 & 0,5 & 0,5 & 0,5 & -\end{bmatrix}](https://drive.google.com/uc?export=view&id=1a4F52xwtXZN5yT-__stSlzqtRQZuN-by)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(SP2)

Note que ![\Phi_k(\Phi_l(sp^{i,j}_{k,l})))](https://drive.google.com/uc?export=view&id=1Uy67KbQOAy0by0u7dgUe2QqGDy9Lb1Lo) só contém valores iguais a 0,5. Visto que os números utilizados neste exemplo foram escolhidos aleatoriamente e que os valores nestas matrizes estão aproximados, por questões e espaço e legibilidade, faz sentido que os resultados fiquem em torno de 0,5 (consenso aleatório, ou ausência de consenso). Perceba ainda, antes disto, que ![\Phi^i(\Phi^j(sp^{i,j}_{1,2})))](https://drive.google.com/uc?export=view&id=1Uy67KbQOAy0by0u7dgUe2QqGDy9Lb1Loo) já havia retornado 0,5 para ambas as opiniões.
 ...
 ![cx_1~\mbox{e}~cx_2=\frac{\sum^2_{l=1,l\neq k}(sp_{k,l} + sp_{l,k})}{2(2-1)}=\frac{(0,5+0,5)}{2}=0,5](https://drive.google.com/uc?export=view&id=1cGLVfVTDwLVCIHehxok7KdrV_mrR7v6L)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 ![cp_i=\frac{\sum^6_{j=1,j\neq i}(sp_{i,j} + sp_{j,i})}{2(6-1)}=\begin{bmatrix}0,5 \\ 0,5 \\ 0,5 \\ 0,5 \\0,5\\ 0,5\end{bmatrix}](https://drive.google.com/uc?export=view&id=1IVZh_AOGu6kUbFHoXSJWypXXSWFo0mXO)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
