...
Afim de concluir nossa análise, sempre que a maioria dos instrutores apoiar uma dada opinião, tomamos esta como a mais acertada. Sendo assim, tomamos *DP* como um vetor de duas dimensões onde na primeira estão as discussões e na segunda, as postagens correspondentes, e identificamos a postagem *p* da discussão *d* na posição *i* como ![p_{di}](https://drive.google.com/uc?export=view&id=https://drive.google.com/open?id=1yru1UlIVVA-l2cuEpyNDHH04EZ9_fdXL); e, *DA* como outro vetor também de duas dimensões correspondendo a discussões e opiniões dos instrutores, respectivamente. Seja agora, ![a_{di}](https://drive.google.com/uc?export=view&id=1ZqxhtiKIsjTfpok1vBV5Rluv9WJCzuFi) a iézima postagem de um instrutor na discussão *d* e ![a_{di}(x)](https://drive.google.com/uc?export=view&id=1l65imPciBTeinOnjKwQCJQpvb71h4hNM), uma função definida no conjunto ![\{0,1\}](https://drive.google.com/uc?export=view&id=1MTvTb01YVPXAFrZewdasethfVLejjjpk) que representa o apoio daquela postagem de instrutor à opinião ![x\in DX](https://drive.google.com/uc?export=view&id=https://drive.google.com/open?id=1GntBiaBwlflpn_KUODlKL-EKGB0giSjB), onde *DX* é outro vetor com dois componentes onde o primeiro representa discussões e o segundo, postagens marcadas como sendo opiniões. Temos então, que a qualidade da opinião ![x_{di}](https://drive.google.com/uc?export=view&id=https://drive.google.com/open?id=1lT6ZAfCUxvHWXT1tbtgGWUQqRTOBCdcG) é definida por 

 ![q_{x_{di}}=\sum_{i=1}^{k}\frac{a_{di}(x_{di})}{k}](https://drive.google.com/uc?export=view&id=https://drive.google.com/open?id=1A3NL6s06lgvfoJcoX2wxkNMIQY3kg1bj)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(8)
 
Na Equação 8, *k* é a quantidade total de opiniões de instrutores na discussão *d*. Assim, quanto mais apoio dos instrutores, maior a qualidade agregada àquela opinião. Deste modo, a qualidade de uma opinião é definida no domínio ![q\in 0,0;1,0](https://drive.google.com/uc?export=view&id=https://drive.google.com/open?id=1WTW0ZEXwIuzKvhY2jN-7joUuNnBIat8K). Além disto, o conceito de consenso utilizado para esta análise está definido no domínio ![0,0;1,0](https://drive.google.com/uc?export=view&id=1_wBzT7sXtLPnrsK4s4GjFiPOUjuJIiiX), porém acaba restrito ao domínio ![0,5;1,0](https://drive.google.com/uc?export=view&id=1ftPe57DPePFb5FehsqY0rfZqhwGhrfGt), sendo ![c=0,5](https://drive.google.com/uc?export=view&id=1viIKsLbSoOr-7JpkVDvXgPMKexcjB_uI) o grau de consenso puramente aleatório. Para enquadrar nossos resultados nos modelos estatísticos apresentados a seguir, normalizamos o consenso em ![0,0;1,0](https://drive.google.com/uc?export=view&id=1_wBzT7sXtLPnrsK4s4GjFiPOUjuJIiiX), tal qual a razão de qualidade *q*.
