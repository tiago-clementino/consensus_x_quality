...
Com isto podemos agora calcular SP, uma matriz que compara todas as preferências ![\mu](https://drive.google.com/uc?export=view&id=12qQAA2wQucSCZVW011XLZGhItRMYkJFT) entre si conforme Equação 2. No caso geral, esta matriz tem quatro dimenssões, mas para nosso exemplo (com apenas duas opiniões) três dimenssões são suficientes para visualizar ![SP_{(6\times 6\times 2)}](https://drive.google.com/uc?export=view&id=12qQAA2wQucSCZVW011XLZGhItRMYkJFT). Para termos uma visualização plana, podemos  utilizar duas visualizações separadas, uma para ![sp^{i,j}_{1,2}](https://drive.google.com/uc?export=view&id=12qQAA2wQucSCZVW011XLZGhItRMYkJFT) e outra para ![sp^{i,j}_{2,1}](https://drive.google.com/uc?export=view&id=12qQAA2wQucSCZVW011XLZGhItRMYkJFT), veja abaixo
